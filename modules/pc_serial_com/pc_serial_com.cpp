...
static void commandShowBatteryLevel();
...
static void pcSerialComCommandUpdate( char receivedChar )
{
    switch (receivedChar) {
        ...
        case 'b': case 'B': commandShowBatteryLevel(); break;
        //case 'g': case 'G': commandShowGPS(); break;
...
static void availableCommands()
{
    ...
    uartUsb.printf( "Press 'b' or 'B' to get the battery level\r\n" ); 
    uartUsb.printf( "Press 'g' or 'G' to get the GPS position\r\n" ); 
    uartUsb.printf( "\r\n" );
}
...
static void commandShowBatteryLevel()
{
    uartUsb.printf("Battery level = %.1f%%\r\n", batteryMeasureInPercent() );
}
